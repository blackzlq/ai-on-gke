...
func (f *JSONFloat64) UnmarshalJSON(data []byte) error {
	...
	if err := json.Unmarshal(data, &s); err == nil {
		...
		case "-Infinity":
			ff = math.Inf(-1)
		default:
			return fmt.Errorf("gke-internal.googlesource.com/k8ssecurityvalidation_pa/client.git/internal: bad float string %q", s)
		}
		*f = JSONFloat64(ff)
		return nil
	}
	return errors.New("gke-internal.googlesource.com/k8ssecurityvalidation_pa/client.git/internal: data not float or string")
}
